(function ()
{
    ...
    /** @ngInject */
    function ToolbarController($rootScope, $window, $q, $state, $timeout, $mdSidenav, $translate, $cookies, $mdToast, msNavigationService)
    {
        var vm = this;
        ...
        vm.user_nameinfo = $cookies.get("USERINFO");
        console.log("vm.user_name1", vm.user_nameinfo);
        vm.userInfo = JSON.parse(decodeURI($cookies.get("USERINFO")));
        vm.user_name = vm.userInfo.name;
        console.log("vm.user_name2", vm.user_name);
        console.log("vm.user_name3", vm.userInfo);
            }
            else {
                vm.user_name = 'John Smith';

            }
        }
 console.log("vm.user_name4", vm.user_name);
        //////////
     ...
     var  abc= windowlocation.origin+"/apps/account/login/"; 
       console.log("url", abc);
     //   $state.go(abc);
     $window.location.href = abc;
        ...
        function changePassword()
        {
            ...
            var windowlocation = $window.location;    
        console.log("windowlocation",windowlocation.origin);
        var abcd = windowlocation.origin+"/apps/settings/changepassword/"; 
